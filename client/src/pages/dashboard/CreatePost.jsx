    ...
    try {
      ...
      if (!row) {
        ...
        const response = await axios.post(
          "https://groom-health-care.onrender.com/CreatePost/create-CreatePost",
          formDataToSend,
          config
        );
        ...
        const response = await axios.post(
          `https://groom-health-care.onrender.com/CreatePost/edit-CreatePost/${row[index].id}`,
          formDataToSend,
          config
        );
        console.log("Form submission response:", response.data);
      ...
      navigate("/admin/CreatePost/display");
    } catch (error) {
      ...
      <div className="w-full flex flex-col justify-center items-center">
        <form onSubmit={handleSubmit}>
          ...
          <div className="mb-5">
            <label
              htmlFor="title"
              className="block mb-2 text-[18px] font-medium text-gray-9index dark:text-white"
            >
              title
            </label>
            <input
